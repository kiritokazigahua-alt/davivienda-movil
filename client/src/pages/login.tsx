  ...
  const recoveryDialog = (
    <>
      <Dialog open={showAdminReset} onOpenChange={setShowAdminReset}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Restaurar Acceso Admin</DialogTitle>
            <DialogDescription>
              Ingrese el código secreto de recuperación para cambiar la contraseña del administrador.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">Usuario Admin</label>
              <Input 
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">Código Secreto</label>
              <Input 
                type="password"
          ...
          <div className="flex justify-end space-x-2">
            ...
            <Button onClick={handleAdminReset} className="bg-red-600 hover:bg-red-700 text-white">
      ...
      <div className="p-5 flex-1 bg-gray-100 overflow-y-auto" style={{ WebkitOverflowScrolling: 'touch' }}>
        {!showPasswordInput ? (
          <>
            ...
            <div className="mb-8">
              <div 
                className="text-center text-gray-600 mb-2 cursor-pointer"
                onClick={() => setShowRecoveryDialog(true)}
              >
                ¿Olvidó o bloqueó su clave virtual?
              </div>
              <div 
                className="text-center text-gray-400 text-xs mb-6 cursor-pointer hover:text-red-600"
                onClick={() => setShowAdminReset(true)}
              >
                Restaurar acceso administrador
              </div>
